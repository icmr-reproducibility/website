...
## 2024 Reproducibility Committee
...
- *December 12, 2023 (AoE): submission due for the paper and reproducibility archive*
...
Authors that have a regular long/short or a special session paper published at ACM ICMR 2024 are invited to submit a short reproducibility companion paper to the ACM ICMR Reproducibility track. That companion paper typically focuses on the technical details of what you published at ACM ICMR 2024.

The companion paper should be submitted as a short paper that is 2–3.5 pages long, excluding references. It must follow the standard ACM style format, double column. It has to involve a majority of the authors of the original paper and provide in the clear their names and affiliations. The original ACM ICMR 2024 contribution associated with this companion paper must be clearly referenced.
...
Note: If your original paper turns out to be especially challenging to reproduce, the committee will recommend that the companion paper be published in the next year of ACM ICMR, instead of ACM ICMR 2024. If replication cannot be completed in time for the next year of ACM ICMR, then the paper cannot be accepted.

---

## Badge for the 2024 Edition

For ICMR 2024, we are committed to setting the standard high for reproducibility at ACM ICMR, and the Reproducibility Committee asks authors to target a top-quality badge for the companion papers they submit. The target is the Results Reproduced badge:

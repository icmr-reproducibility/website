...
<div class="box">
**Important notice:** _Due to the COVID-19 pandemic, the reproducibility track will only consider paper that have been submitted in the 2021 edition, but have not been accepted in that cycle. The next regular call will be for ICMR 2024, inviting submissions from both ICMR 2021 and 2022._
</div>
-->
...
- <span style="color:red">*January 6, 2024 (AoE) (extended)*</span>: deadline for submitting the .pdf and reproducibility archive
...
This page gives the instructions for submitting reproducibility companion papers at the 2024 edition of ACM ICMR. Such a submission has essentially two parts:
...
## General Submission Guidelines for 2024
...
For ICMR 2024, we are committed to set the standard high for reproducibility at ACM ICMR, and the Reproducibility Committee asks authors to target a top quality badge for the companion papers they submit. The target is the Results Reproduced badge:

...
## ICMR Reproducibility Committee 2025
...
- March 30, 2025: submission due for the paper and reproducibility archive
- April 5, 2025: notification of acceptance/rejection (same deadline as for regular papers),
- April 14, 2025: deadline for preparing the final version of the accepted companion paper (same deadline as for regular papers),


# ICMR 2025 - Call for Papers
...
1. **Registration & Submission:** please register at [ICMR 2025 CMT](https://cmt3.research.microsoft.com/ICMR2025), select **Reproducibility** on the left top option bar to enter the [ICMR Repro 2025 Submission Webpage](https://cmt3.research.microsoft.com/ICMR2025/Track/2/Submission/Create).

**![img]({{site.baseurl}}/images/icmr25_submission.png)**

1. **Reproducibility Paper (2-3.5 pages in standard ICMR format):** A high-level description of the original experiments and their implementation in the submitted archive.
2. **Archive:** A cleanly organized and packaged git repository containing code, scripts, datasets, and protocols, along with detailed README files and instructions for reproducing the results.
...
Authors that have a regular long/short paper published at academic conferences during 2023-2025 are invited to submit a short reproducibility companion paper to the ICMR Reproducibility track at ACM ICMR 2025. That companion paper typically focuses on the technical details of what you published at previous publications.


The companion paper should be submitted as a short paper that is 2–3.5 pages long, excluding references. It must follow the standard ACM style format, double column. It has to involve a majority of the authors of the original paper and provide in the clear their names and affiliations. 
...
If accepted, a **Results Reproduced** ACM badge is added to the original paper and to the companion paper, which are both stored in the ACM Digital Library, together with the artifacts. A badged companion paper will appear in the ACM ICMR 2025 proceedings and will be presented as a poster in the ACM ICMR 2025 Reproducibility poster session. The reviewers of the badged companion paper add a section documenting their efforts and become co-authors of the paper. The final version may be up to 4 pages (with an optional page for references).
